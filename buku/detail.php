    ...
    <div class="p-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="flex justify-center">
          <img src="../admin/buku/image/<?= htmlspecialchars($book['image']); ?>" class="w-full h-auto rounded-lg shadow" alt="<?= htmlspecialchars($book['judul']); ?>">
        </div>
        <div>
          <ul class="space-y-4">
          ...
          <a href="pengajuan.php?id=<?=$book['id']?>"  class="inline-block py-2 px-4 bg-green-500 text-white rounded-md hover:bg-green-400 my-6">Ajukan Peminjaman</a>
        </div>
      </div>
      <div class="mt-6">
