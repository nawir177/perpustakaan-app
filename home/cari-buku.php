...
<div class="contianer">
  ...
  <section class="mb-10">
    <div class="flex gap-4 items-center">
      <?php foreach ($kategori as $val) :  ?>
        <div class="col">
          <a href="home.php?kategori=<?= $val['nama'] ?>" class="w-56 h-20 bg-white shadow rounded-xl flex gap-4 justify-center items-center my-auto ">
            <div class="col">
  ...
  <section class="mb-8">
    ...
    <div class="flex max-w-6xl w-full gap-4 overflow-x-scroll p-6 rounded-xl shadow mt-6 bg-green-50">
      <?php for ($i = 0; $i < 30; $i++) :  ?>
        <div class="">
          <div class="h-64 w-52 bg-gray-500 bg-cover shadow" style="background-image: url('../image/book/2.jpg');"></div>
  ...
  <section class="mb-8">
    ...
    <div class="flex max-w-6xl w-full gap-4 overflow-x-scroll p-6 rounded-xl shadow mt-6 bg-green-50">
      <?php for ($i = 0; $i < 30; $i++) :  ?>
        <div class="">
          <div class="h-64 w-52 bg-gray-500 bg-cover shadow" style="background-image: url('../image/book/1.jpg');"></div>
  ...
  <!-- fiksi list -->
  <section class="mb-8">
    <h2 class="text-gray-900 text-4xl font-thin">Fiksi</h2>
    <div class="flex max-w-6xl w-full gap-4 overflow-x-scroll p-6 rounded-xl shadow mt-6 bg-green-50">
      <?php for ($i = 0; $i < 30; $i++) :  ?>
        <div class="">
          <div class="h-64 w-52 bg-gray-500 bg-cover shadow" style="background-image: url('../image/book/3.jpeg');"></div>
  ...
  <!-- non fiksi list -->
  <section class="mb-8">
    <h2 class="text-gray-900 text-4xl font-medium">Non Fiksi</h2>
    <div class="flex max-w-6xl w-full gap-4 overflow-x-scroll p-6 rounded-xl shadow mt-6 bg-green-50">
      <?php for ($i = 0; $i < 30; $i++) :  ?>
        <div class="">
          <div class="h-64 w-52 bg-gray-500 bg-cover shadow" style="background-image: url('../image/book/4.jpeg');"></div>
