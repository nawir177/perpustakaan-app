...
<div class="container my-4">
   ...
   <div class="card">
      ...
      <div class="card-body">
         <div class="row">
            <div class="col-md-4">
               <img src="../buku/image/<?= htmlspecialchars($book['image']); ?>" class="img-fluid rounded shadow-sm" alt="<?= htmlspecialchars($book['judul']); ?>">
            </div>
            <div class="col-md-8">
               <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item"><strong>Jumlah:</strong> <?= htmlspecialchars($book['jumlah']); ?></li>
                  <li class="list-group-item"><strong>Lokasi:</strong> <?= htmlspecialchars($book['lokasi']); ?></li>
               </ul>
               <div class="p-2">
                  <h1>Deskripsi</h1>
